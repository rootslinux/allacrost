...
/** \brief Determines if the probability (1% to 100%) of something occuring has happened
*** \param chance Integer typically between 0 and100. 0 will always return false and >=100 will always return true.
*** \return True if the event being randomized has occurred.
**/
bool RandomProbability(uint32 chance);
//@}
