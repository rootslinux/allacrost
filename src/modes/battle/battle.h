...
public:
	...
	*** \return A pointer to the appropriate icon image, or nullptr if the skill type was invalid
	**/
	...
	*** \return The icon representation of the element type and intensity, or nullptr if no appropriate image was found
	**/
...
private:
	...
	*** Target types include ally, enemy, and parties.
	**/
...
public:
	...
	//@{
	//! \brief Sets the descriptions of the possible battle command inputs
