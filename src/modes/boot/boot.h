...
public:
	...
	//! \brief Sets the descriptions of the possible boot command inputs
...
private:
	...
	**/
	...
	void _SetSwapKey(const SDL_Keycode &key);
	void _SetLeftSelectKey(const SDL_Keycode &key);
	void _SetRightSelectKey(const SDL_Keycode &key);
