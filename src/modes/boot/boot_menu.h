...
public:
	...
	**/
	void AddOption(const hoa_utils::ustring & text, void (BootMode::*confirm_function)() = nullptr,
		void (BootMode::*up_function)() = nullptr,   void (BootMode::*down_function)() = nullptr,
		void (BootMode::*left_function)() = nullptr, void (BootMode::*right_function)() = nullptr);
