...
*** The tablespace's purpose is to prevent any name collision of variables, functions, and so on between multiple
*** Lua files, similar to how namespaces are used in C++. The tablespace is near the top of the Lua file and looks
*** like this:
***
*** local ns = {}
...
private:
	...
	***
	*** \return A pointer to the lua_State for the file, or nullptr if the file has never been opened.
	**/
